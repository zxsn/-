...
<body>
	<form action="delActionn.action"  id="post">
		<table align="center" id="tb1">
			...
			<c:forEach items="${pageInfo.students}" var="student">
				<tr>
					<td align="center" class="cart_td_1"><input
						name="cartCheckBox" type="checkbox" value="${student.stid}"></td>
			...
			<tr>
				<td colspan="4" align="center" class="tt">
					<div>
						...
						<a
							href="${pageInfo.uri}nowPage.currentPage=${pageInfo.totalPages}">尾页</a>
					</div>
				</td>
			</tr>
			<tr>
				<td colspan="4" align="right"><input type="submit" value="提交" onclick="getTableContent(this)"/></td>
			</tr>
		</table>
	</form>
</body>
